...
<!-- Mirrored from themedox.com/demo/tourex/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Jul 2025 07:38:39 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Tourex - Tour & Travel Booking html5 Template</title>
    <meta name="description" content="Tourex - Tour & Travel Booking html5 Template">
...
<body>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-7 col-5">
                        <div class="tgmenu__wrap d-flex align-items-center">
                            <div class="logo">
                                <a class="logo-1" href="index.html"><img src="assets/img/logo/logo-white.png" alt="Logo"></a>
                                <a class="logo-2 d-none" href="index.html"><img src="assets/img/logo/logo-green.png" alt="Logo"></a>
                            </div>
    ...
    <main>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="tg-hero-bg">
                                <div class="tg-hero-thumb" data-background="assets/img/hero/hero-1.jpg"></div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="tg-hero-bg">
                                <div class="tg-hero-thumb" data-background="assets/img/hero/hero-2.jpg"></div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="tg-hero-bg">
                                <div class="tg-hero-thumb" data-background="assets/img/hero/hero-3.jpg"></div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="tg-hero-bg">
                                <div class="tg-hero-thumb" data-background="assets/img/hero/hero-4.jpg"></div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="tg-hero-bg">
                                <div class="tg-hero-thumb" data-background="assets/img/hero/hero-5.jpg"></div>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-xl-10">
                                <div class="tg-hero-content text-center">
                                    <div class="tg-hero-title-box mb-10">
                                        <h5 class="tg-hero-subtitle mb-5 wow fadeInUp" data-wow-delay=".3s" data-wow-duration=".7s">* This offer valid till 22 August</h5>
                                        <h2 class="tg-hero-title wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".9s">Maldives island</h2>
                                        <p class="tg-hero-para mb-0  wow fadeInUp" data-wow-delay=".6s" data-wow-duration="1.1s">when an unknown printer took ar galley offer type area <br> year anddey make specimen book</p>
                                    </div>
                                    ...
                                    <div class="tg-hero-btn-box  wow fadeInUp" data-wow-delay=".8s" data-wow-duration="1.5s">
                                        <a href="contact.html" class="tg-btn tg-btn-switch-animation">
                        ...
                        <div class="tg-booking-form-wrap">
                            <div class="tg-booking-form-tabs">
                                <div class="nav nav-tab justify-content-center" id="nav-tab" role="tablist">
                                    <button class="nav-links active" id="nav-platform-tab" data-bs-toggle="tab" data-bs-target="#nav-platform" type="button" role="tab" aria-controls="nav-platform" aria-selected="true">
                                        <span class="borders"></span>
                                        <span class="icon">
                                            <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M16.5 2.5L8.8 10.2M16.5 2.5L11.6 16.5L8.8 10.2M16.5 2.5L2.5 7.4L8.8 10.2" stroke="currentColor" stroke-width="1.1" stroke-linecap="round" stroke-linejoin="round" />
                                            </svg>
                                        </span>
                                       <span>Tour</span>
                                    </button>
                                    <button class="nav-links" id="nav-tracking-tab" data-bs-toggle="tab" data-bs-target="#nav-tracking" type="button" role="tab" aria-controls="nav-tracking" aria-selected="false">
                                        <span class="borders"></span>
                                        <span class="icon">
                                    ...
                                    <button class="nav-links" id="nav-support-tab" data-bs-toggle="tab" data-bs-target="#nav-support" type="button" role="tab" aria-controls="nav-support" aria-selected="false">
                                        <span class="borders"></span>
                                        <span class="icon">
                                    ...
                                    <button class="nav-links" id="nav-terms-tab" data-bs-toggle="tab" data-bs-target="#nav-terms" type="button" role="tab" aria-controls="nav-terms" aria-selected="false">
                                        <span class="borders"></span>
                                        <span class="icon">
                                    ...
                                    <button class="nav-links" id="nav-activity-tab" data-bs-toggle="tab" data-bs-target="#nav-activity" type="button" role="tab" aria-controls="nav-activity" aria-selected="false">
                                        <span class="borders"></span>
                                        <span class="icon">
                                            <svg width="18" height="12" viewBox="0 0 18 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M16.5 1.5L10.0227 8.625L6.61364 4.875L1.5 10.5M16.5 1.5H12.4091M16.5 1.5L16.5 6" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                            </svg>
                                        </span>
                                        <span>Activity</span>
                                    </button>
                                    <button class="nav-links" id="nav-car-tab" data-bs-toggle="tab" data-bs-target="#nav-car" type="button" role="tab" aria-controls="nav-car" aria-selected="false">
                                        <span class="borders"></span>
                                        <span class="icon">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="nav-platform" role="tabpanel" aria-labelledby="nav-platform-tab" tabindex="0">
                                ...
                                <div class="tab-pane fade" id="nav-tracking" role="tabpanel" aria-labelledby="nav-tracking-tab" tabindex="0">
                                    <div class="tg-booking-form-item">
                                        <form action="#">
                                            <div class="tg-booking-form-input-group d-flex align-items-end justify-content-between">
                                                <div class="tg-booking-form-parent-inner tg-hero-quantity p-relative mr-15 mb-15">
                                ...
                                <div class="tab-pane fade" id="nav-terms" role="tabpanel" aria-labelledby="nav-terms-tab" tabindex="0">
                                    <div class="tg-booking-form-item">
                                        <form action="#">
                                            <div class="tg-booking-form-input-group d-flex align-items-end justify-content-between">
                                                <div class="tg-booking-form-parent-inner tg-hero-quantity p-relative mr-15 mb-15">
                                ...
                                <div class="tab-pane fade" id="nav-car" role="tabpanel" aria-labelledby="nav-car-tab" tabindex="0">
                                    <div class="tg-booking-form-item">
                                        <form action="#">
                                            <div class="tg-booking-form-input-group d-flex align-items-end justify-content-between">
                                                <div class="tg-booking-form-parent-inner tg-hero-quantity p-relative mr-15 mb-15">
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="tg-about-thumb-wrap mb-30">
                            <img class="w-100 tg-round-15 mb-85 wow fadeInLeft" data-wow-delay=".3s" data-wow-duration=".7s" src="assets/img/about/about.jpg" alt="about">
                            <img class="tg-about-thumb-2 tg-round-15 wow fadeInLeft" data-wow-delay=".4s" data-wow-duration=".9s" src="assets/img/about/about-2.jpg" alt="about">
                        </div>
                    </div>
                    <div class="col-lg-6 mb-30">
                        <div class="tg-about-content text-center">
                            ...
                            <div class="tg-about-section-title mb-25">
                                <h5 class="tg-section-subtitle wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".6s">Most Popular Tour</h5>
                                <h2 class="mb-15 wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".7s">Let’s Discover The World With Our Excellent Eyes</h2>
                                <p class="text-capitalize wow fadeInUp" data-wow-delay=".6s" data-wow-duration=".8s">Whether you're looking for a romantic getawaamily-friendly  
                    ...
                    <div class="col-lg-3">
                        <div class="tg-about-thumb-wrap  mb-30">
                            <img class="w-100 tg-round-15 mb-85 wow fadeInRight" data-wow-delay=".3s" data-wow-duration=".7s" src="assets/img/about/about-3.jpg" alt="about">
                            <img class="tg-about-thumb-4 tg-round-15 wow fadeInRight" data-wow-delay=".4s" data-wow-duration=".9s" src="assets/img/about/about-4.jpg" alt="about">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="tg-listing-area tg-grey-bg pt-140 pb-110 p-relative z-index-9">
            <img class="tg-listing-shape d-none d-lg-block" src="assets/img/listing/about-shape.png" alt="">
            <img class="tg-listing-shape-2 d-none d-xl-block" src="assets/img/listing/about-shape-2.png" alt="">
            <img class="tg-listing-shape-3 d-none d-lg-block" src="assets/img/listing/about-shape-3.png" alt="">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="tg-listing-section-title text-center mb-35">
                            <h5 class="tg-section-subtitle wow fadeInUp" data-wow-delay=".3s" data-wow-duration=".5s">Most Popular Tour Packages </h5>
                            <h2 class="mb-15 wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".6s">Something Amazing Waiting For you</h2>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="tg-listing-menu-nav project__menu-nav mb-40 wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".9s">
                            ...
                            <button class="" data-filter=".cat-four">
                                <span class="borders"></span>
                                <span class="icon">
                                    <svg width="18" height="12" viewBox="0 0 18 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M16.5 1.5L10.0227 8.625L6.61364 4.875L1.5 10.5M16.5 1.5H12.4091M16.5 1.5L16.5 6" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            ...
                            <button class="" data-filter=".cat-five">
                                <span class="borders"></span>
                                <span class="icon">
                                    <svg width="19" height="12" viewBox="0 0 19 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M4.20913 0.5C3.45763 0.5 2.76351 0.8674 2.34557 1.47955L0.781259 3.7659C0.59716 4.03549 0.499257 4.35254 0.50001 4.6767V8.32045C0.498973 8.5646 0.581457 8.80209 0.734344 8.99513C0.887231 9.18817 1.10174 9.32568 1.34376 9.3858L2.80288 9.74715C2.90782 10.2415 3.18344 10.6854 3.58349 11.0046C3.98355 11.3238 4.48369 11.4987 5.00001 11.5C6.04176 11.5 6.91138 10.7955 7.16226 9.85H12.4003C12.6511 10.7955 13.5208 11.5 14.5625 11.5C15.6042 11.5 16.4739 10.7955 16.7247 9.85H17.375C17.9904 9.85 18.5 9.3517 18.5 8.75V6.7392C18.4995 6.24896 18.3314 5.77295 18.0225 5.38681C17.7136 5.00066 17.2816 4.72652 16.7951 4.60795L13.7536 3.8517L11.5565 1.2909C11.3463 1.04361 11.0831 0.844562 10.7854 0.707879C10.4877 0.571197 10.163 0.500226 9.83413 0.5H4.20913ZM4.20913 1.6H6.68751V3.8H2.1172L3.27763 2.0983V2.08125C3.37955 1.93158 3.51808 1.80917 3.68065 1.72513C3.84322 1.64108 4.02525 1.59807 4.20913 1.6ZM7.8125 1.6H9.83413C10.1677 1.6 10.4821 1.7441 10.6953 1.99545L12.2422 3.8H7.8125V1.6ZM1.62501 4.9H13.3672L16.5312 5.6733C16.774 5.73221 16.9894 5.86948 17.1425 6.06291C17.2956 6.25634 17.3776 6.49461 17.375 6.7392V8.75H16.7247C16.4739 7.80455 15.6042 7.1 14.5625 7.1C13.5208 7.1 12.6511 7.80455 12.4003 8.75H7.16226C6.91138 7.80455 6.04176 7.1 5.00001 7.1C4.00269 7.1 3.16513 7.7446 2.8732 8.62955L1.62501 8.321V4.9ZM5.00001 8.2C5.62832 8.2 6.12501 8.68565 6.12501 9.3C6.12501 9.91435 5.62832 10.4 5.00001 10.4C4.37169 10.4 3.87501 9.91435 3.87501 9.3C3.87501 8.68565 4.37169 8.2 5.00001 8.2ZM14.5625 8.2C15.1908 8.2 15.6875 8.68565 15.6875 9.3C15.6875 9.91435 15.1908 10.4 14.5625 10.4C13.9342 10.4 13.4375 9.91435 13.4375 9.3C13.4375 8.68565 13.9342 8.2 14.5625 8.2Z" fill="currentColor" />
                ...
                <div class="row project-active-two">
                    <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 grid-item grid-sizer cat-three cat-one">
                        <div class="tg-listing-card-item mb-30">
                            <div class="tg-listing-card-thumb fix mb-15 p-relative">
                                <a href="tour-details.html">
                                    <img class="tg-card-border w-100" src="assets/img/listing/listing-3.jpg" alt="listing">
                            ...
                            <div class="tg-listing-card-content">
                                <h4 class="tg-listing-card-title"><a href="tour-details.html">Two Hour Walking Tour of Manhattan</a></h4>
                    ...
                    <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 grid-item grid-sizer cat-two cat-one cat-five">
                        <div class="tg-listing-card-item mb-30">
                            <div class="tg-listing-card-thumb fix mb-15 p-relative">
                                <a href="tour-details.html">
                                    <img class="tg-card-border w-100" src="assets/img/listing/listing-2.jpg" alt="listing">
                            ...
                            <div class="tg-listing-card-content">
                                <h4 class="tg-listing-card-title"><a href="tour-details.html">When you visit the Eternal Dubai City</a></h4>
                                <div class="tg-listing-card-duration-tour">
                                    <span class="tg-listing-card-duration-map mb-5">
                                        <svg width="13" height="16" viewBox="0 0 13 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M12.3329 6.7071C12.3329 11.2324 6.55512 15.1111 6.55512 15.1111C6.55512 15.1111 0.777344 11.2324 0.777344 6.7071C0.777344 5.16402 1.38607 3.68414 2.46962 2.59302C3.55316 1.5019 5.02276 0.888916 6.55512 0.888916C8.08748 0.888916 9.55708 1.5019 10.6406 2.59302C11.7242 3.68414 12.3329 5.16402 12.3329 6.7071Z" stroke="currentColor" stroke-width="1.15556" stroke-linecap="round" stroke-linejoin="round" />
                            ...
                            <div class="tg-listing-card-price d-flex align-items-end justify-content-between">
                                <div class="tg-listing-card-price-wrap price-bg d-flex align-items-end">
                                    <span class="tg-listing-card-currency-amount mr-5">
                                        <del class="tg-listing-card-currency-old">$299</del>
                                        <span class="currency-symbol">$</span>149
                                    </span>
                                    <span class="tg-listing-card-activity-person">/Person</span>
                                </div>
                                <div class="tg-listing-card-review space">
                    ...
                    <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 grid-item grid-sizer cat-four  cat-two">
                        <div class="tg-listing-card-item mb-30">
                            <div class="tg-listing-card-thumb fix mb-15 p-relative">
                                <a href="tour-details.html">
                                    <img class="tg-card-border w-100" src="assets/img/listing/listing-1.jpg" alt="listing">
                                    <span class="tg-listing-item-price-discount shape">New</span>
                                </a>
                                <div class="tg-listing-item-wishlist">
                                    <a href="#">
                            ...
                            <div class="tg-listing-card-content">
                                <h4 class="tg-listing-card-title"><a href="tour-details.html">The Pulau Seribu, Jakarta Indonesia</a></h4>
                                <div class="tg-listing-card-duration-tour">
                                    <span class="tg-listing-card-duration-map mb-5">
                                        <svg width="13" height="16" viewBox="0 0 13 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M12.3329 6.7071C12.3329 11.2324 6.55512 15.1111 6.55512 15.1111C6.55512 15.1111 0.777344 11.2324 0.777344 6.7071C0.777344 5.16402 1.38607 3.68414 2.46962 2.59302C3.55316 1.5019 5.02276 0.888916 6.55512 0.888916C8.08748 0.888916 9.55708 1.5019 10.6406 2.59302C11.7242 3.68414 12.3329 5.16402 12.3329 6.7071Z" stroke="currentColor" stroke-width="1.15556" stroke-linecap="round" stroke-linejoin="round" />
                            ...
                            <div class="tg-listing-card-price d-flex align-items-end justify-content-between">
                                <div class="tg-listing-card-price-wrap price-bg d-flex align-items-center">
                                    <span class="tg-listing-card-currency-amount mr-5">
                                        <span class="currency-symbol">$</span>349
                                    </span>
                                    <span class="tg-listing-card-activity-person">/Person</span>
                                </div>
                                <div class="tg-listing-card-review space">
                    ...
                    <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 grid-item grid-sizer cat-four cat-three">
                        <div class="tg-listing-card-item mb-30">
                            <div class="tg-listing-card-thumb fix mb-15 p-relative">
                                <a href="tour-details.html">
                                    <img class="tg-card-border w-100" src="assets/img/listing/listing-5.jpg" alt="listing">
                                    <span class="tg-listing-item-price-discount shape-3">
                                        <svg width="12" height="14" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M6.60156 1L0.601562 8.2H6.00156L5.40156 13L11.4016 5.8H6.00156L6.60156 1Z" stroke="white" stroke-width="0.857143" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                        Featured
                                    </span>
                            ...
                            <div class="tg-listing-card-content">
                                <h4 class="tg-listing-card-title"><a href="tour-details.html">American Parks Trail end Rapid City Express</a></h4>
                                <div class="tg-listing-card-duration-tour">
                                    <span class="tg-listing-card-duration-map mb-5">
                                        <svg width="13" height="16" viewBox="0 0 13 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M12.3329 6.7071C12.3329 11.2324 6.55512 15.1111 6.55512 15.1111C6.55512 15.1111 0.777344 11.2324 0.777344 6.7071C0.777344 5.16402 1.38607 3.68414 2.46962 2.59302C3.55316 1.5019 5.02276 0.888916 6.55512 0.888916C8.08748 0.888916 9.55708 1.5019 10.6406 2.59302C11.7242 3.68414 12.3329 5.16402 12.3329 6.7071Z" stroke="currentColor" stroke-width="1.15556" stroke-linecap="round" stroke-linejoin="round" />
                            ...
                            <div class="tg-listing-card-price d-flex align-items-end justify-content-between">
                                <div class="tg-listing-card-price-wrap price-bg d-flex align-items-end">
                                    <span class="tg-listing-card-currency-amount mr-5">
                                        <del class="tg-listing-card-currency-old">$280</del>
                                        <span class="currency-symbol">$</span>255
                                    </span>
                                    <span class="tg-listing-card-activity-person">/Person</span>
                                </div>
                                <div class="tg-listing-card-review space">
                    ...
                    <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 grid-item grid-sizer  cat-one cat-five">
                        <div class="tg-listing-card-item mb-30">
                            <div class="tg-listing-card-thumb fix mb-15 p-relative">
                                <a href="tour-details.html">
                                    <img class="tg-card-border w-100" src="assets/img/listing/listing-6.jpg" alt="listing">
                                </a>
                                <div class="tg-listing-item-wishlist">
                                    <a href="#">
                                        <svg width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="tg-listing-card-content">
                                <h4 class="tg-listing-card-title"><a href="tour-details.html">southwestern Switzerland Akam City</a></h4>
                                <div class="tg-listing-card-duration-tour">
                                    <span class="tg-listing-card-duration-map mb-5">
                                        <svg width="13" height="16" viewBox="0 0 13 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M12.3329 6.7071C12.3329 11.2324 6.55512 15.1111 6.55512 15.1111C6.55512 15.1111 0.777344 11.2324 0.777344 6.7071C0.777344 5.16402 1.38607 3.68414 2.46962 2.59302C3.55316 1.5019 5.02276 0.888916 6.55512 0.888916C8.08748 0.888916 9.55708 1.5019 10.6406 2.59302C11.7242 3.68414 12.3329 5.16402 12.3329 6.7071Z" stroke="currentColor" stroke-width="1.15556" stroke-linecap="round" stroke-linejoin="round" />
                            ...
                            <div class="tg-listing-card-price d-flex align-items-end justify-content-between">
                                <div class="tg-listing-card-price-wrap price-bg d-flex align-items-end">
                                    <span class="tg-listing-card-currency-amount mr-5">
                                        <del class="tg-listing-card-currency-old">$240</del>
                                        <span class="currency-symbol">$</span>180
                                    </span>
                                    <span class="tg-listing-card-activity-person">/Person</span>
                                </div>
                                <div class="tg-listing-card-review space">
                    ...
                    <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 grid-item grid-sizer cat-four">
                        <div class="tg-listing-card-item mb-30">
                            <div class="tg-listing-card-thumb fix mb-15 p-relative">
                                <a href="tour-details.html">
                                    <img class="tg-card-border w-100" src="assets/img/listing/listing-7.jpg" alt="listing">
                                    <span class="tg-listing-item-price-discount shape-3">
                                        <svg width="12" height="14" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M6.60156 1L0.601562 8.2H6.00156L5.40156 13L11.4016 5.8H6.00156L6.60156 1Z" stroke="white" stroke-width="0.857143" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                            ...
                            <div class="tg-listing-card-content">
                                <h4 class="tg-listing-card-title"><a href="tour-details.html">Modern Stefano La Piazze Wergeland</a></h4>
                                <div class="tg-listing-card-duration-tour">
                                    <span class="tg-listing-card-duration-map mb-5">
                                        <svg width="13" height="16" viewBox="0 0 13 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M12.3329 6.7071C12.3329 11.2324 6.55512 15.1111 6.55512 15.1111C6.55512 15.1111 0.777344 11.2324 0.777344 6.7071C0.777344 5.16402 1.38607 3.68414 2.46962 2.59302C3.55316 1.5019 5.02276 0.888916 6.55512 0.888916C8.08748 0.888916 9.55708 1.5019 10.6406 2.59302C11.7242 3.68414 12.3329 5.16402 12.3329 6.7071Z" stroke="currentColor" stroke-width="1.15556" stroke-linecap="round" stroke-linejoin="round" />
                    ...
                    <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 grid-item grid-sizer cat-three cat-one cat-five">
                        <div class="tg-listing-card-item mb-30">
                            <div class="tg-listing-card-thumb fix mb-15 p-relative">
                                <a href="tour-details.html">
                                    <img class="tg-card-border w-100" src="assets/img/listing/listing-8.jpg" alt="listing">
                                </a>
                                <div class="tg-listing-item-wishlist">
                                    <a href="#">
                                        <svg width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="tg-listing-card-content">
                                <h4 class="tg-listing-card-title"><a href="tour-details.html">Vatican Museums, Sistine Chapel Skip the Line</a></h4>
                                <div class="tg-listing-card-duration-tour">
                                    <span class="tg-listing-card-duration-map mb-5">
                                        <svg width="13" height="16" viewBox="0 0 13 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M12.3329 6.7071C12.3329 11.2324 6.55512 15.1111 6.55512 15.1111C6.55512 15.1111 0.777344 11.2324 0.777344 6.7071C0.777344 5.16402 1.38607 3.68414 2.46962 2.59302C3.55316 1.5019 5.02276 0.888916 6.55512 0.888916C8.08748 0.888916 9.55708 1.5019 10.6406 2.59302C11.7242 3.68414 12.3329 5.16402 12.3329 6.7071Z" stroke="currentColor" stroke-width="1.15556" stroke-linecap="round" stroke-linejoin="round" />
                            ...
                            <div class="tg-listing-card-price d-flex align-items-end justify-content-between">
                                <div class="tg-listing-card-price-wrap price-bg d-flex align-items-end">
                                    <span class="tg-listing-card-currency-amount mr-5">
                                        <del class="tg-listing-card-currency-old">$299</del>
                                        <span class="currency-symbol">$</span>142
                                    </span>
                                    <span class="tg-listing-card-activity-person">/Person</span>
                                </div>
                                <div class="tg-listing-card-review space">
                    ...
                    <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 grid-item grid-sizer cat-three cat-four">
                        <div class="tg-listing-card-item mb-30">
                            <div class="tg-listing-card-thumb fix mb-15 p-relative">
                                <a href="tour-details.html">
                                    <img class="tg-card-border w-100" src="assets/img/listing/listing-4.jpg" alt="listing">
                                </a>
                                <div class="tg-listing-item-wishlist">
                                    <a href="#">
                                        <svg width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="tg-listing-card-content">
                                <h4 class="tg-listing-card-title"><a href="tour-details.html">win cities on opposite sides of the</a></h4>
                                <div class="tg-listing-card-duration-tour">
                                    <span class="tg-listing-card-duration-map mb-5">
                                        <svg width="13" height="16" viewBox="0 0 13 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M12.3329 6.7071C12.3329 11.2324 6.55512 15.1111 6.55512 15.1111C6.55512 15.1111 0.777344 11.2324 0.777344 6.7071C0.777344 5.16402 1.38607 3.68414 2.46962 2.59302C3.55316 1.5019 5.02276 0.888916 6.55512 0.888916C8.08748 0.888916 9.55708 1.5019 10.6406 2.59302C11.7242 3.68414 12.3329 5.16402 12.3329 6.7071Z" stroke="currentColor" stroke-width="1.15556" stroke-linecap="round" stroke-linejoin="round" />
                            ...
                            <div class="tg-listing-card-price d-flex align-items-end justify-content-between">
                                <div class="tg-listing-card-price-wrap price-bg d-flex align-items-end">
                                    <span class="tg-listing-card-currency-amount mr-5">
                                        <del class="tg-listing-card-currency-old">$240</del>
                                        <span class="currency-symbol">$</span>110
                                    </span>
                                    <span class="tg-listing-card-activity-person">/Person</span>
                                </div>
                                <div class="tg-listing-card-review space">
        ...
        <div class="tg-chose-area p-relative pt-135 pb-100">
            <img class="tg-chose-shape p-absolute" src="assets/img/chose/chose-shape-2.png" alt="shape">
            <div class="container">
                <div class="row">
                    <div class="col-lg-5">
                        <div class="tg-chose-content mb-25">
                            <div class="tg-chose-section-title mb-30">
                                <h5 class="tg-section-subtitle mb-15 wow fadeInUp" data-wow-delay=".3s" data-wow-duration=".1s">Dream Your Next Trip</h5>
                                <h2 class="mb-15 text-capitalize wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".9s">discover when even<br> you want to go</h2>
                                <p class="text-capitalize wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".9s">Are you tired of the typical tourist destinations and looking 
                                ...
                                <div class="tg-chose-list d-flex mb-15 wow fadeInUp" data-wow-delay=".6s" data-wow-duration=".9s">
                                    <span class="tg-chose-list-icon mr-20">
                                        <svg width="60" height="65" viewBox="0 0 60 65" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <path d="M8.25475 39.4661C6.41764 37.564 5.4011 35.0446 5.4011 32.374C5.4011 26.844 9.77342 22.3343 15.1623 22.3343C17.0361 22.3343 18.861 22.8886 20.4409 23.9215L20.6491 24.0601L19.3876 26.0756L19.1794 25.937C17.9792 25.1434 16.5952 24.7277 15.1623 24.7277C11.0716 24.7277 7.74036 28.1541 7.74036 32.3614C7.74036 34.4021 8.51194 36.3169 9.92039 37.7655L15.1745 43.1696L20.4287 37.7655C21.8249 36.3169 22.6087 34.4021 22.6087 32.3614C22.6087 31.4419 22.4495 30.5475 22.1433 29.6909L22.0576 29.4516L24.2376 28.6076L24.3233 28.8469C24.7275 29.968 24.9357 31.1521 24.9357 32.3614C24.9357 35.0446 23.9192 37.564 22.0821 39.4535L15.1868 46.5455L8.25475 39.4661Z" fill="#0162FD" />
                                            <path d="M21.3962 28.2422C21.1145 27.7888 20.7716 27.3605 20.4042 26.97L20.2327 26.7936L21.8861 25.093L22.0576 25.2694C22.5475 25.7733 22.9884 26.3401 23.368 26.9322L23.5028 27.1463L21.5432 28.4438L21.3962 28.2422Z" fill="#0162FD" />
                                            <path d="M32.7373 48.8508L38.4568 43.0814L42.4985 46.9864L49.5285 39.7558H46.4421V37.3624H53.4966V44.6182H51.1696V41.4564L42.5475 50.3246L38.4936 46.407L34.3662 50.564L32.7373 48.8508Z" fill="#0162FD" />
                                            <path d="M31.7435 53.2243L33.4043 51.548L31.7744 49.8398L30.1137 51.5162L31.7435 53.2243Z" fill="#0162FD" />
                                            <path d="M29.1167 55.8693L30.7775 54.193L29.1477 52.4848L27.4869 54.1612L29.1167 55.8693Z" fill="#0162FD" />
                                            <path d="M17.3301 10.4176L17.5505 10.3043C19.0692 9.46027 20.6614 8.78004 22.3025 8.26357L22.5352 8.18798L23.2211 10.4806L22.9884 10.5562C21.4942 11.0223 20.0367 11.6521 18.665 12.4205L18.4446 12.5339L17.3301 10.4176Z" fill="#0162FD" />
                                            <path d="M37.4893 57.5804L37.722 57.5048C39.0814 57.0262 40.4164 56.4089 41.6779 55.6909L41.8861 55.5649L43.0251 57.656L42.8169 57.782C41.4329 58.5756 39.9633 59.2558 38.4691 59.7723L38.2364 59.8479L37.4893 57.5804Z" fill="#0162FD" />
                                            <path d="M34.0968 58.4622L34.3417 58.4118C34.9173 58.2985 35.493 58.1725 36.0563 58.0213L36.289 57.9583L36.8769 60.2762L36.6442 60.3391C36.0196 60.5029 35.395 60.6541 34.7581 60.7674L34.5132 60.8178L34.0968 58.4622Z" fill="#0162FD" />
                                            <path d="M37.3668 30.2955H35.0398V32.689H37.3668V30.2955Z" fill="#0162FD" />
                                            <path d="M33.6803 30.2955H31.3533V32.689H33.6803V30.2955Z" fill="#0162FD" />
                                          </svg>
                                    </span>
                                    <div class="tg-chose-list-content">
                                        <h4 class="tg-chose-list-title mb-5">Best Travel Agency</h4>
                                        <p>Are you tired of the typical tourist destinatio
                                            and looking  step out of your comfort.</p>
                                    </div>
                                </div>
                                <div class="tg-chose-list d-flex mb-40 wow fadeInUp" data-wow-delay=".7s" data-wow-duration=".9s">
                                    <span class="tg-chose-list-icon mr-20">
                                        <svg width="59" height="66" viewBox="0 0 59 66" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M15.2344 21.8281C15.101 21.8281 14.9689 21.8543 14.8457 21.9054C14.7224 21.9564 14.6105 22.0312 14.5161 22.1255C14.4218 22.2198 14.347 22.3318 14.296 22.455C14.245 22.5783 14.2187 22.7104 14.2188 22.8438V55.3438C14.2187 55.4771 14.245 55.6092 14.296 55.7325C14.347 55.8557 14.4218 55.9677 14.5161 56.062C14.6105 56.1563 14.7224 56.2311 14.8457 56.2821C14.9689 56.3332 15.101 56.3594 15.2344 56.3594H19.2969C19.4303 56.3594 19.5623 56.3332 19.6856 56.2821C19.8088 56.2311 19.9208 56.1563 20.0151 56.062C20.1094 55.9677 20.1842 55.8557 20.2353 55.7325C20.2863 55.6092 20.3125 55.4771 20.3125 55.3438V22.8438C20.3125 22.7104 20.2863 22.5783 20.2353 22.455C20.1842 22.3318 20.1094 22.2198 20.0151 22.1255C19.9208 22.0312 19.8088 21.9564 19.6856 21.9054C19.5623 21.8543 19.4303 21.8281 19.2969 21.8281H15.2344ZM18.2812 54.3281H16.25V23.8594H18.2812V54.3281Z" fill="#0162FD" />
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-6">
                                    <div class="tg-chose-thumb">
                                        <img class="tg-chose-shape-2 mb-30 ml-15 d-none d-lg-block" src="assets/img/chose/chose-shape.png" alt="shape">
                                        <img class="w-100 wow fadeInRight" data-wow-delay=".4s" data-wow-duration=".9s" src="assets/img/chose/chose.png" alt="chose">
                                    </div>
                                </div>
                                <div class="col-lg-9 col-md-6">
                                    <div class="tg-chose-thumb-inner p-relative">
                                        <div class="tg-chose-thumb-2 wow fadeInRight" data-wow-delay=".5s" data-wow-duration=".9s">
                                            <img class="w-100 tg-round-15" src="assets/img/chose/chose-2.jpg" alt="chose">
                                        </div>
        ...
        <div class="tg-banner-area tg-banner-space">
            <div class="container">
                <div class="row gx-0">
                    <div class="col-lg-7">
                        <div class="tg-banner-video-wrap include-bg" data-background="assets/img/banner/thumb.jpg">
                    ...
                    <div class="col-lg-5">
                        <div class="tg-banner-content p-relative z-index-1 text-center">
                            <img class="tg-banner-shape" src="assets/img/banner/shape.png" alt="shape">
                            <h4 class="tg-banner-subtitle mb-10">Enjoy Summer Deals</h4>
                            <h2 class="tg-banner-title mb-25">Up to 40% Discount!</h2>
        ...
        <div class="tg-location-area p-relative pb-40 tg-grey-bg pt-140">
            <img class="tg-location-shape d-none d-lg-block" src="assets/img/location/shape-2.png" alt="shape">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="tg-location-section-title text-center mb-30">
                            ...
                            <p class="text-capitalize wow fadeInUp" data-wow-delay=".6s" data-wow-duration=".9s">Are you tired of the typical tourist destinations and looking<br> 
        ...
        <!-- tg-banner-area-start -->
        <div class="tg-banner-area include-bg" data-background="assets/img/banner/banner.png">
            <div class="container">
                <div class="col-lg-12">
                    <div class="tg-banner-2-content text-center">
                        <div class="tg-about-section-title mb-25">
                            <h5 class="tg-section-subtitle mb-10 wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".9s">Next Adventure Destination</h5>
                            <h2 class="tg-section-title-white mb-25 wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".9s">Popular Travel Destinations <br>Available Worldwide</h2>
                        </div>
        ...
        <div class="tg-testimonial-area pt-105 pb-100">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="tg-location-section-title text-center mb-30">
                            <h5 class="tg-section-subtitle mb-15 wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".9s">Clients Feedback About Us</h5>
                            <h2 class="mb-15 text-capitalize wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".9s">See Those Lovely Words From Clients</h2>
                            <p class="text-capitalize wow fadeInUp" data-wow-delay=".6s" data-wow-duration=".9s">Are you tired of the typical tourist destinations and looking<br> 
                                to step out of your comfort zonetravel</p>
                        </div>
                    </div>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="tg-testimonial-item mb-30">
                                    ...
                                    <p class="tg-testimonial-avatar-para mb-10">“ Morem ipsum dolor siter amet areaeey consec taetur adipisc Service ollwing 
        ...
        <div class="tg-blog-area tg-blog-space tg-grey-bg pt-135 p-relative z-index-1">
            <img class="tg-blog-shape" src="assets/img/blog/shape.png" alt="shape">
            <img class="tg-blog-shape-2" src="assets/img/blog/shape-2.png" alt="shape">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="tg-location-section-title text-center mb-30">
                            ...
                            <p class="text-capitalize wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".9s">Are you tired of the typical tourist destinations and<br> looking 
                                to step out of your comfort zonetravel</p>
                        </div>
                    </div>
                    <div class="col-lg-5 wow fadeInLeft" data-wow-delay=".4s" data-wow-duration=".9s">
                        <div class="tg-blog-item mb-25">
                            <div class="tg-blog-thumb fix">
                                <a href="blog-details.html"><img class="w-100" src="assets/img/blog/blog-1.jpg" alt="blog"></a>
                            </div>
                            <div class="tg-blog-content  p-relative">
                                <span class="tg-blog-tag p-absolute">Travel River</span>
                                <h3 class="tg-blog-title"><a href="blog-details.html">Spiritual Sojourn: Pilgrimagee Tours 
                    ...
                    <div class="col-lg-7">
                        <div class="row">
                            <div class="col-12 wow fadeInRight" data-wow-delay=".4s" data-wow-duration=".9s">
                                <div class="tg-blog-item mb-20">
                                    <div class="row align-items-center">
                                        <div class="col-lg-5">
                                            <div class="tg-blog-thumb fix">
                                                <a href="blog-details.html"><img class="w-100" src="assets/img/blog/blog-2.jpg" alt="blog"></a>
                                            </div>
                                        </div>
                                        <div class="col-lg-7">
                                            <div class="tg-blog-contents">
                                                <span class="tg-blog-tag d-inline-block mb-10">Hiking</span>
                                                <h3 class="tg-blog-title title-2 mb-0"><a href="blog-details.html">Wine Country Escapes: Vineyard 
                            ...
                            <div class="col-12 wow fadeInRight" data-wow-delay=".5s" data-wow-duration=".9s">
                                <div class="tg-blog-item mb-20">
                                    <div class="row align-items-center">
                                        <div class="col-lg-5">
                                            <div class="tg-blog-thumb fix">
                                                <a href="blog-details.html"><img class="w-100" src="assets/img/blog/blog-3.jpg" alt="blog"></a>
                                            </div>
                                        </div>
                                        <div class="col-lg-7">
                                            <div class="tg-blog-contents">
                                                <span class="tg-blog-tag d-inline-block mb-10">Adventure</span>
                                                <h3 class="tg-blog-title title-2 mb-0"><a href="blog-details.html">Thrills & Chills: Extreme Sports 
                            ...
                            <div class="row align-items-end">
                                ...
                                <div class="col-lg-5 col-md-6">
                                    <div class="tg-cta-content">
                                        ...
                                        <h2 class="mb-15 tg-cta-title text-white text-capitalize">Download Our App <br> Form Google & App Store!</h2>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6">
                                    <div class="tg-cta-apps">
                                        <a class="mb-20 d-inline-block mr-5" href="#"><img src="assets/img/cta/google.png" alt=""></a>
                                        <a class="mb-20 d-inline-block" href="#"><img src="assets/img/cta/app.png" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!-- Mirrored from themedox.com/demo/tourex/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Jul 2025 07:38:48 GMT -->
</html>
